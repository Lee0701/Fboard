...
object HangulTables {
    ...
    val LAYOUT_3SET_SHIN_ORIGINAL_L0 = SimpleCodeConvertTable(
        ...
        KeyEvent.KEYCODE_I to Entry(0x1106, 0x100116e),
        KeyEvent.KEYCODE_O to Entry(0x110e, 0x100116e),
        KeyEvent.KEYCODE_P to Entry(0x1111, 0x1001169),
    ...
    val LAYOUT_3SET_SHIN_ORIGINAL_L1 = SimpleCodeConvertTable(
        ...
        KeyEvent.KEYCODE_Y to Entry(0x1105, 0x1105),
        KeyEvent.KEYCODE_U to Entry(0x1103, 0x1103),
        KeyEvent.KEYCODE_I to Entry(0x100116e, 0x1106),
        KeyEvent.KEYCODE_O to Entry(0x100116e, 0x110e),
        KeyEvent.KEYCODE_P to Entry(0x1001169, 0x1111),
        ...
        KeyEvent.KEYCODE_N to Entry(0x1109, 0x1109),
        KeyEvent.KEYCODE_M to Entry(0x1112, 0x2f),
        KeyEvent.KEYCODE_SLASH to Entry(0x1001169, 0x3f),
        CustomKeycode.KEYCODE_PERIOD_COMMA.code to Entry(0x2e, 0x2c)
    )
    ...
    val COMB_3SET_SHIN = JamoCombinationTable(
        ...
        listOf(0x1001169, 0x1161, 0x116a),
        listOf(0x1001169, 0x1162, 0x116b),
        listOf(0x1001169, 0x1175, 0x116c),
        listOf(0x100116e, 0x1165, 0x116f),
        listOf(0x100116e, 0x1166, 0x1170),
        listOf(0x100116e, 0x1175, 0x1171),
        listOf(0x1001173, 0x1175, 0x1174),
        listOf(0x100119e, 0x1175, 0x11a1),
        listOf(0x100119e, 0x119e, 0x11a2),
        listOf(0x100119e, 0x100119e, 0x11a2),
