...
object HangulTables {
    ...
    val COMB_3SET_SHIN = JamoCombinationTable(
        ...
        listOf(0x101169, 0x1161, 0x116a),
        listOf(0x101169, 0x1162, 0x116b),
        listOf(0x101169, 0x1175, 0x116c),
        listOf(0x10116e, 0x1165, 0x116f),
        listOf(0x10116e, 0x1166, 0x1170),
        listOf(0x10116e, 0x1175, 0x1171),
        listOf(0x101173, 0x1175, 0x1174),
        listOf(0x10119e, 0x1175, 0x11a1),
        listOf(0x10119e, 0x119e, 0x11a2),
        listOf(0x10119e, 0x10119e, 0x11a2),
